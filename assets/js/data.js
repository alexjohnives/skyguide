const wingInformation = {
    wingImage0: {
        ...
        title: 'Ilse WL 1',
        description1:
            'Enter the first cave and walk to the end. Fly or jump down to the stranded boat below.',
        description2:
    ...
    wingImage5: {
        id: 'wingInfo6',
        title: 'Prairie WL 1 Butterfly Fields',
    ...
    wingImage6: {
        id: 'wingInfo7',
        title: 'Prairie WL 2 Butterfly Fields',
        description1:
    ...
    wingImage7: {
        id: 'wingInfo8',
        title: 'Prairie WL 3 Butterfly Fields',
        description1:
    ...
    wingImage21: {
        ...
        description2:
            'This light is hidden behind the flow on the lowest level.',
